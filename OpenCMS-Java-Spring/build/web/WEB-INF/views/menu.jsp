...
<div style="background-color: darkslategray; padding: 5px 0">
    <a href="home" style="color: whitesmoke; display: inline-block">
        <div style="width:150px; height: 40px;background-color: dimgray;margin: 5px">
            Home
        </div>
    </a>
    <a href="create_material" style="color: whitesmoke;display: inline-block">
        <div style="width:150px; height: 40px;background-color: dimgray;margin: 5px">
            Create material
        </div>
    </a>
    <a href="categories" style="color: whitesmoke;display: inline-block">
        <div style="width:150px; height: 40px;background-color: dimgray;margin: 5px">
            Categories
        </div>
    </a>
